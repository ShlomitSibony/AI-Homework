...
import abstract
from Reversi.consts import OPPONENT_COLOR, BOARD_COLS, BOARD_ROWS, lineBonus
from players.AI2_311155543_319201257.Improvements import updateTable, holesScore
from players.AI2_311155543_319201257.utils import INFINITY, ExceededTimeError, MiniMaxWithAlphaBetaPruning
...
class Player(abstract.AbstractPlayer):
    def __init__(self, setup_time, player_color, time_per_k_turns, k):
        ...
        self.deepSum = 0
        self.moves = 0
        self.bonusTable = self.createBonusTable()
    ...
    def get_move(self, game_state, possible_moves):
        ...
        while timeRemaining:
            try:
                u,move = minimax.search(game_state,depth,-INFINITY,INFINITY,True)
                best_move = move
                #print('going deeper ', depth, ' with move: ', best_move, ' and u: ', u)
                depth += 1
                # if move == None:
                #     print('-----------------move is Null------------------')
                #     break
    ...
    def printStat(self):
        print('algorithm: alpha beta in a total of {} moves we arrive in avg to {} deep' , self.moves , self.deepSum/self.moves)
